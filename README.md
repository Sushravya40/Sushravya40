...
<h3 align="center">Software Developer | Java Full Stack | Spring Boot • React • MySQL • Python</h3>
...
I am a Full-Stack Developer passionate about building scalable, responsive web applications and solving real-world problems. I'm currently focused on advanced React, Spring Boot, and AI integrations.<br>
**[Read my full story & see my timeline →](https://sushravya40.github.io/-/)**
...
A robust Spring Boot + React e-commerce application with seamless Razorpay integration.<br>
...
A highly interactive Task Manager built with React, Vite, and a glassmorphism UI.<br>
...
A Django web application exclusively for vegetarian food delivery with Razorpay checkouts.<br>
...
A Python-based machine learning model (Random Forest, Ada Boost) to predict stress levels.<br>
...
A modern, responsive e-commerce platform for home decor items currently under active development.<br>
...
- **MCA** @ *The National Institute of Engineering, Mysore* (2025)
- **BCA** @ *PES Degree College, Mandya* (2023)
